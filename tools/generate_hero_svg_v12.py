...
def generate_hero_svg():
    # Set seed for consistent, "good" looking shape (same as v5/v6/v9/v10/v11)
    random.seed(55) 
    ...
    # Colors - UPDATED V12 for even better visibility/contrast
    # Up color: Stronger, darker Blue
    up_color = "#0056b3" 
    # Down color: Darker Blue-Grey for high contrast
    down_color = "#475569" 
    # Wick color: Almost black
    wick_color = "#1e293b"
