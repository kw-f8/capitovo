...
OUTPUT_FILE = 'weltkarte_simplified.svg'
AREA_THRESHOLD = 5.0  # Lower threshold to keep more parts
SIMPLIFY_TOLERANCE = 2.0 # Tolerance for simplification
...
def main():
    ...
    print(f"Simplifying polygons with tolerance {SIMPLIFY_TOLERANCE}...")
    simplified_geoms = []
    ...
    filtered_polygons = [p for p in simplified_geoms if p.area >= AREA_THRESHOLD]
