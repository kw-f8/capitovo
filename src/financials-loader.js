(function(){
  ...
  var FINN_KEY = (window.FINNHUB_API_KEY && String(window.FINNHUB_API_KEY).trim()) || 'd2gpq9hr01qq1li05scgd2gpq9hr01qq1li05sd0';
  var symbol = 'AAPL';
  ...
  function fetchFinnhub(){
    ...
    return Promise.all([fetch(profileUrl), fetch(metricUrl)]).then(function(res){
      ...
      var m = metricsObj.metric || {};
          // Debug log raw values to help diagnose mapping issues
