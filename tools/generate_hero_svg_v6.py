...
def generate_candlestick_svg():
    # Set seed for consistent, "good" looking shape (same as v5)
    random.seed(55) 
    ...
    svg_parts.append('@keyframes appear { from { opacity: 0; transform: translateY(10px); } to { opacity: 1; transform: translateY(0); } }')
    svg_parts.append('</style>')
    ...
    for i, candle in enumerate(prices):
        ...
        svg_parts.append(f'<g class="candle-group" style="animation-delay: {delay:.2f}s">')
