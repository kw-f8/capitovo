...
def generate_candlestick_svg():
    width = 800
    height = 250 # Reduced height further
    padding = 20
    num_candles = 60
    ...
    # Drop Shadow Filter
    svg_parts.append('<filter id="dropShadow" x="-20%" y="-20%" width="140%" height="140%">')
    svg_parts.append('<feGaussianBlur in="SourceAlpha" stdDeviation="2"/>')
    svg_parts.append('<feOffset dx="1" dy="2" result="offsetblur"/>')
    svg_parts.append('<feComponentTransfer><feFuncA type="linear" slope="0.2"/></feComponentTransfer>') # Reduced opacity of shadow
