...
def generate_hero_svg():
    # Set seed for consistent, "good" looking shape (same as v5/v6/v9/v10)
    random.seed(55) 
    ...
    # Up color: Brand Accent Blue
    up_color = "#0091d6" 
    # Down color: Darker Grey (Slate 500) for better contrast against white
    down_color = "#64748b" 
    # Wick color: Dark Slate (Slate 700) for sharp visibility
    wick_color = "#334155"
